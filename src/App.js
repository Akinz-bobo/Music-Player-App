...
function App() {
  ...
  const [songs, setSongs] = useState([
    {
      cover: require("./assets/picture/godzilla.jfif"),
      song_name: "godzilla",
      singer: "eminem",
      musicSrc: require("./assets/musics/godzilla.mp3"),
      musicId: "1",
      genre: 'HipHop',
      LikeMusic: "false"
    },
    {
      cover: require("./assets/picture/LilTecca.jfif"),
      song_name: "Faster",
      singer: "Lil Tecca",
      musicSrc: require("./assets/musics/LilTeccaFaster.mp3"),
      musicId: "2",
      genre: 'HipHop',
      LikeMusic: "false"
    },
    {
      cover: require("./assets/picture/something-just-like.jfif"),
      song_name: "Something-Just-Like",
      singer: "Chainsmokers",
      musicSrc: require("./assets/musics/Chainsmokers-Coldplay-Something-Just-Like.mp3"),
      musicId: "3",
      genre: 'pop',
      LikeMusic: "false"
    },
  ...
  return (
    <>
      <ApiContext.Provider value={{ id, setId, songs, setSongs, playing, setPlaying, setLikedMusic, likedMusic, toggleTheme, Theme, t, i18n, setSearchValue, searchValue }}>
